...
public class PoemTests {
	...
	public void ifItContainsASpecificWord() throws Exception {
		assertThat(luuletus.hasWord(luuletusRunnel, "Jumal"), is(true));
	}
	...
	@Test
	public void countHowManyTimesAWordAppearsInThePoem() throws Exception {
